...
PROJECT_ROOT = os.path.join(BASE_DIR, "..")           # 上一级目录

nnUNet_raw = os.path.join(PROJECT_ROOT, "nnUNetFrame", "nnUNet_raw")
nnUNet_preprocessed = os.path.join(PROJECT_ROOT, "nnUNetFrame", "nnUNet_preprocessed")
nnUNet_results = os.path.join(PROJECT_ROOT, "nnUNetFrame", "nnUNet_results") 
